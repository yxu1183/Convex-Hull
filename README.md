...
* The program gets the input data from a file [random.txt](https://github.com/yxu1183/Convex-Hull/blob/master/random.txt) generated by [random.c](http://ranger.uta.edu/~alex/). 
* It can either read from the file, or can read from the keyboard combined with redirection of input.
* Generats random points as directed by the user - [random.c](http://ranger.uta.edu/~alex/).
